...
function PostForm({post}) {
    ...
    const submit = async(data) => {
        ...
        const dbPost = appwriteServices.updatePost(post.$id, {...data,
            featuredImage: file? file.$id: undifined
        })
        if(dbPost){
        ...
        //todo: rewrite file with condition file data.image[0] ? await appwriteServices.uploadFile(data.image[0]) : null
